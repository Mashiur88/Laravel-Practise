...
unset($__errorArgs, $__bag); ?>" name="first_name" value="<?php echo e(old('first_name')); ?>" autocomplete="first_name" autofocus>
...
unset($__errorArgs, $__bag); ?>" name="user_name" value="<?php echo e(old('user_name')); ?>" autocomplete="user_name" autofocus>
...
unset($__errorArgs, $__bag); ?>" name="password" value="<?php echo e(old('password')); ?>" autocomplete="new-password">
...
unset($__errorArgs, $__bag); ?>" name="password_confirmation" value="<?php echo e(old('password_confirmation')); ?>" autocomplete="new-password">
                            </div>
                        </div>
...
unset($__errorArgs, $__bag); ?>"  name="gender" value="1" autocomplete="male" autofocus><label class="form-check-label" for="male">Male</label>
                                </div>
                                <div class="form-check">
...
unset($__errorArgs, $__bag); ?>" name="gender" value="2" autocomplete="female" autofocus><label class="form-check-label" for="female">Female</label>
                                </div>
...
unset($__errorArgs, $__bag); ?>" name="status" value="1" autocomplete="active" autofocus><label class="form-check-label" for="active">Active</label>
                                </div>
                                <div class="form-check">
...
unset($__errorArgs, $__bag); ?>" name="status" value="0" autocomplete="inactive" autofocus><label class="form-check-label" for="inactive">Inactive</label>
                                </div>
                                <?php $__errorArgs = ['gender'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
